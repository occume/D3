...
import org.d3.rpc.support.Client;
import org.d3.rpc.support.Listener;
	...
	public static <T> T getProxy(final Class<T> clazz,String host,int port) {
		...
		InvocationHandler handler = new InvocationHandler() {
			...
			public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
				...
				invo.setMethod(new org.d3.rpc.protocal.Method(method.getName(),method.getParameterTypes()));
				invo.setParams(args);
				client.invoke(invo);
