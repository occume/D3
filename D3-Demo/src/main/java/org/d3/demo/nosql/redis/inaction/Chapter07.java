...
public class Chapter07 {
    ...
    public static final void main(String[] args) {
    	Chapter07 cp7 = new Chapter07();
    	cp7.run();
//    	long sc =  cp7.stringToScore("宁安寨");
//    	long sc1 = cp7.stringToScore("abcdefg");
...
//        testIndexAndFindJobs(conn);
    ...
    public void testIndexDocument(Jedis conn) {
        ...
        Set<String> tokens = tokenize(CONTENT1);
        ...
        int count = indexDocument(conn, "test", CONTENT1);
    ...
    public void testSetOperations(Jedis conn) {
        System.out.println("\n----- testSetOperations -----");
        indexDocument(conn, "test", CONTENT1);
        indexDocument(conn, "test1", CONTENT1);
    ...
    public void testParseQuery(Jedis conn) {
        ...
        System.out.println(query.unwanted);
    ...
    public void testParseAndSearch(Jedis conn) {
        ...
        System.out.println(conn.smembers("idx:" + id));
    ...
    public void testSearchWithSort(Jedis conn) {
        ...
        indexDocument(conn, "test", CONTENT1);
        indexDocument(conn, "test2", CONTENT1);
    ...
    public void testStringToScore(Jedis conn) {
        ...
        System.out.println(pairs.equals(pairs2));
...
System.out.println(lower);
    ...
    public void testIndexAndTargetAds(Jedis conn) {
        ...
        indexAd(conn, "1", new String[]{"USA", "CA"}, CONTENT1, Ecpm.CPC, .25);
        indexAd(conn, "2", new String[]{"USA", "VA"}, CONTENT1 + " wooooo", Ecpm.CPC, .125);

        String[] usa = new String[]{"USA"};
        for (int i = 0; i < 100; i++) {
            targetAds(conn, usa, CONTENT1);
        }
        Pair<Long,String> result = targetAds(conn, usa, CONTENT1);
